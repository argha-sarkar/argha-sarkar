...
const DEFAULT_DATA = {
  ...
  hero: {
    firstName: "Argha",
    lastName: "Sarkar",
    statusText: "STATUS · ONLINE · INDIA",
    typingPhrases: [
    ...
    ctaButtons: [
      { label: "./view_projects.sh", href: "#projects", style: "primary" },
      { label: "./connect.sh",       href: "#connect",  style: "outline" },
      { label: "./email.sh",         href: "mailto:arghasarkar5373@gmail.com", style: "outline" }
    ]
  },
  about: {
    name:        "Argha Sarkar",
    ...
    location:    "India 🇮🇳",
    experience:  "5+ Years (IT Ops → AI Engineering)",
    phone:       "+91-7439018427",
  ...
  arsenal: {
    categories: [
      {
        icon: "🧠", title: "Deep Learning & AI",
        badges: ["PyTorch","TensorFlow","Keras","HuggingFace","LangChain","OpenCV","YOLOv8","Ollama"]
      },
      {
        icon: "⚙️", title: "MLOps & Infrastructure",
        badges: ["Docker","Kubernetes","MLflow","FastAPI","GitHub Actions","W&B","ChromaDB","FAISS"]
      },
      {
        icon: "🐍", title: "Languages & Data",
        badges: ["Python","R","SQL","Bash","Pandas","NumPy","Scikit-Learn","Power BI"]
      },
      {
        icon: "🛡️", title: "Security & Systems",
        badges: ["Linux","Kali Linux","Wireshark","MySQL","MongoDB","IBM DB2","Git","VS Code"]
      }
    ],
    proficiency: [
      { label: "Python & Data Engineering",    width: "100%", level: "Expert"       },
      { label: "Deep Learning (PyTorch/TF)",   width: "100%", level: "Expert"       },
      { label: "Computer Vision",              width: "85%",  level: "Advanced"     },
      { label: "Natural Language Processing",  width: "85%",  level: "Advanced"     },
      { label: "MLOps & Production AI",        width: "80%",  level: "Advanced"     },
      { label: "LLMs & RAG Systems",           width: "75%",  level: "Proficient"   },
      { label: "Cyber Security & OSINT",       width: "70%",  level: "Proficient"   },
      { label: "Quantitative Finance",         width: "60%",  level: "Intermediate" }
    ]
  },
  experience: [
    {
  ...
  achievements: {
    metrics: [
      { value: "5", suffix: "+", label1: "Years of",      label2: "IT Experience"       },
      { value: "5", suffix: "+", label1: "Production AI", label2: "Projects Shipped"    },
      { value: "6", suffix: "",  label1: "Professional",  label2: "Certifications"      },
      { value: "2", suffix: "",  label1: "Advanced",      label2: "Degrees"             },
      { value: "∞", suffix: "",  label1: "Models Trained",label2: "& Broken"            }
    ],
    rhythm: {
  ...
  stats: {
    languages: [
      ...
      { name: "C++",        pct: 10, color: "#f34b7d" },
      { name: "HTML",       pct:  8, color: "#e34c26" },
      { name: "CSS",        pct:  5, color: "#563d7c" },
      { name: "JavaScript", pct:  3, color: "#f1e05a" },
      { name: "R",          pct:  2, color: "#276DC3" }
    ],
    weekly: [
      { label: "🧠 Deep Learning Research", pct: 85, time: "26h 30m" },
      { label: "📚 MBA Coursework",         pct: 63, time: "15h 30m" },
      { label: "🐍 Python Engineering",     pct: 20, time: "01h 20m" },
      { label: "👔 Leadership & Strategy",  pct: 30, time: "03h 00m" },
      { label: "🔐 Security Research",      pct: 12, time: "00h 45m" }
    ]
  },
  research: [
    ...
    { title: "🎭 Deepfake & Synthetic Media Detection",
      desc: "Building robust forensic classifiers to identify GAN-generated and diffusion-model-generated synthetic media. Research focus: temporal artifact analysis, frequency domain anomalies, and adversarial robustness." },
